...
pub(crate) const ASPECT_RATIO: u32 = SCREEN_WIDTH / SCREEN_HEIGHT;

pub(crate) const DISPATCH_SIZE_X: u32 = ((SCREEN_WIDTH).saturating_add(32)) / 32;
pub(crate) const DISPATCH_SIZE_Y: u32 = ((SCREEN_HEIGHT).saturating_add(32)) / 32;
